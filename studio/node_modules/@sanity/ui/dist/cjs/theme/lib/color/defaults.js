...
exports.defaultOpts = {
    ...
    solid: function (_a) {
        var dark = _a.dark, state = _a.state, tone = _a.tone;
    ...
    button: function (_a) {
        var mode = _a.mode, muted = _a.muted, solid = _a.solid;
        if (mode === 'bleed') {
            return __assign(__assign({}, muted), { enabled: {
                    bg: 'transparent',
                    fg: muted.enabled.fg,
                    border: 'transparent',
                }, hovered: {
        ...
        if (mode === 'ghost')
            return __assign(__assign({}, solid), { enabled: muted.enabled });
        return solid;
    },
    card: function () {
        return {
