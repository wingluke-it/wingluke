...
function vars(base, color) {
    ...
    return styled_components_1.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    --card-bg-color: ", ";\n    --card-fg-color: ", ";\n    --card-focus-ring-color: ", ";\n    --card-hairline-soft-color: ", ";\n    --card-hairline-hard-color: ", ";\n    --card-muted-fg-color: ", ";\n    --card-accent-fg-color: ", ";\n    --card-link-fg-color: ", ";\n    --card-code-bg-color: ", ";\n    --card-code-fg-color: ", ";\n\n    /* @todo: deprecate */\n    --card-link-color: ", ";\n\n    /* @todo: rename to \"--base-\"? */\n    --card-shadow-outline-color: ", ";\n    --card-shadow-umbra-color: ", ";\n    --card-shadow-penumbra-color: ", ";\n    --card-shadow-ambient-color: ", ";\n  "], ["\n    --card-bg-color: ", ";\n    --card-fg-color: ", ";\n    --card-focus-ring-color: ", ";\n    --card-hairline-soft-color: ", ";\n    --card-hairline-hard-color: ", ";\n    --card-muted-fg-color: ", ";\n    --card-accent-fg-color: ", ";\n    --card-link-fg-color: ", ";\n    --card-code-bg-color: ", ";\n    --card-code-fg-color: ", ";\n\n    /* @todo: deprecate */\n    --card-link-color: ", ";\n\n    /* @todo: rename to \"--base-\"? */\n    --card-shadow-outline-color: ", ";\n    --card-shadow-umbra-color: ", ";\n    --card-shadow-penumbra-color: ", ";\n    --card-shadow-ambient-color: ", ";\n  "])), color.bg, color.fg, base.focusRing, color.border, color.border, color.muted.fg, color.accent.fg, color.link.fg, color.code.bg, color.code.fg, color.link.fg, base.shadow.outline, base.shadow.umbra, base.shadow.penumbra, base.shadow.ambient);
}
