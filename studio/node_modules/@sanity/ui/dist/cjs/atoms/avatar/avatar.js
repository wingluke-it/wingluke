...
var Root = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  background-color: ", ";\n  position: relative;\n  box-sizing: border-box;\n  user-select: none;\n  width: ", ";\n  height: ", ";\n  border-radius: ", ";\n  box-shadow: 0 0 0 1px var(--card-bg-color);\n\n  &[data-status='inactive'] {\n    opacity: 0.5;\n  }\n\n  & > svg {\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n\n    &:not([hidden]) {\n      display: block;\n    }\n  }\n\n  &:is(button) {\n    appearance: none;\n    margin: 0;\n    padding: 0;\n    border: 0;\n    font: inherit;\n    -webkit-font-smoothing: inherit;\n    color: inherit;\n    outline: none;\n\n    &:focus {\n      box-shadow: 0 0 0 1px var(--card-bg-color), 0 0 0 3px var(--card-focus-ring-color);\n    }\n\n    &:focus:not(:focus-visible) {\n      box-shadow: none;\n    }\n  }\n"], ["\n  background-color: ", ";\n  position: relative;\n  box-sizing: border-box;\n  user-select: none;\n  width: ", ";\n  height: ", ";\n  border-radius: ", ";\n  box-shadow: 0 0 0 1px var(--card-bg-color);\n\n  &[data-status='inactive'] {\n    opacity: 0.5;\n  }\n\n  & > svg {\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n\n    &:not([hidden]) {\n      display: block;\n    }\n  }\n\n  &:is(button) {\n    appearance: none;\n    margin: 0;\n    padding: 0;\n    border: 0;\n    font: inherit;\n    -webkit-font-smoothing: inherit;\n    color: inherit;\n    outline: none;\n\n    &:focus {\n      box-shadow: 0 0 0 1px var(--card-bg-color), 0 0 0 3px var(--card-focus-ring-color);\n    }\n\n    &:focus:not(:focus-visible) {\n      box-shadow: none;\n    }\n  }\n"])), function (_a) {
    var uiColor = _a.uiColor;
    return uiColor;
}, function (_a) {
    var size = _a.size;
    return styles_1.rem(theme_2.avatarTheme.size[size]);
}, function (_a) {
    var size = _a.size;
    return styles_1.rem(theme_2.avatarTheme.size[size]);
}, function (_a) {
    var size = _a.size;
    return styles_1.rem(theme_2.avatarTheme.size[size] / 2);
}, function (_a) {
    var size = _a.size;
    return styles_1.rem(theme_2.avatarTheme.size[size]);
}, function (_a) {
...
exports.Avatar = react_1.forwardRef(function (props, ref) {
    ...
    var _sizeRem = theme_2.avatarTheme.size[size];
    var _radius = theme_2.avatarTheme.size[size] / 2;
    var elementId = auto_id_1.useId();
    var _d = react_1.useState(animateArrowFrom || arrowPositionProp || 'inside'), arrowPosition = _d[0], setArrowPosition = _d[1];
    var _e = react_1.useState(false), imageFailed = _e[0], setImageFailed = _e[1];
    ...
    return (react_1.default.createElement(Root, __assign({ as: as, "data-ui": "Avatar" }, restProps, { "aria-label": title, "data-arrow-position": arrowPosition, "data-status": status, ref: ref, size: size, title: title, uiColor: color }),
        ...
        !imageFailed && src && (react_1.default.createElement("svg", { viewBox: "0 0 " + _sizeRem + " " + _sizeRem, fill: "none" },
            ...
            react_1.default.createElement(BgStroke, { cx: _radius, cy: _radius, rx: _radius, ry: _radius }),
            react_1.default.createElement(Stroke, { cx: _radius, cy: _radius, rx: _radius, ry: _radius, stroke: color }))),
        (imageFailed || !src) && initials && (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(Initials, null,
                size === 0 && (react_1.default.createElement(text_1.Text, { as: "span", size: 0 },
                    react_1.default.createElement("strong", null, initials))),
                size === 1 && (react_1.default.createElement(text_1.Text, { as: "span", size: 2 },
                    react_1.default.createElement("strong", null, initials))),
                size === 2 && (react_1.default.createElement(text_1.Text, { as: "span", size: 3 },
                    react_1.default.createElement("strong", null, initials))))))));
});
