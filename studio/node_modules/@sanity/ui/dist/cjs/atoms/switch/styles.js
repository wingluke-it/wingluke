...
function switchRepresentationStyles(props) {
    ...
    var switchInput = theme.sanity.input.switch;
    var color = theme.sanity.color.button.default;
    return styled_components_1.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    --switch-bg-color: ", ";\n    --switch-fg-color: ", ";\n\n    &&:not([hidden]) {\n      display: block;\n    }\n    position: relative;\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n\n    /* Make sure it\u2019s not possible to interact with the wrapper element */\n    pointer-events: none;\n\n    /* Focus styles */\n    input:focus + & {\n      /* @todo: Use focus ring color from card theme */\n      box-shadow: 0 0 0 1px var(--card-bg-color), 0 0 0 3px var(--card-focus-ring-color);\n    }\n\n    input:focus:not(:focus-visible) + & {\n      box-shadow: none;\n    }\n\n    input:hover + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    input:checked + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    input:checked:hover + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    input:disabled + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n  "], ["\n    --switch-bg-color: ", ";\n    --switch-fg-color: ", ";\n\n    &&:not([hidden]) {\n      display: block;\n    }\n    position: relative;\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n\n    /* Make sure it\u2019s not possible to interact with the wrapper element */\n    pointer-events: none;\n\n    /* Focus styles */\n    input:focus + & {\n      /* @todo: Use focus ring color from card theme */\n      box-shadow: 0 0 0 1px var(--card-bg-color), 0 0 0 3px var(--card-focus-ring-color);\n    }\n\n    input:focus:not(:focus-visible) + & {\n      box-shadow: none;\n    }\n\n    input:hover + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    input:checked + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    input:checked:hover + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    input:disabled + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n  "])), color.default.enabled.bg, color.default.enabled.fg, styles_1.rem(switchInput.width), styles_1.rem(switchInput.height), styles_1.rem(switchInput.height / 2), color.default.hovered.bg, color.default.hovered.fg, color.positive.enabled.bg, color.positive.enabled.fg, color.positive.hovered.bg, color.positive.hovered.fg, color.default.disabled.fg, color.default.disabled.bg);
}
...
function switchTrackStyles(props) {
    var theme = props.theme;
    var switchInput = theme.sanity.input.switch;
    return styled_components_1.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    &&:not([hidden]) {\n      display: block;\n    }\n    background: var(--switch-bg-color);\n    position: absolute;\n    left: 0;\n    top: 0;\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n  "], ["\n    &&:not([hidden]) {\n      display: block;\n    }\n    background: var(--switch-bg-color);\n    position: absolute;\n    left: 0;\n    top: 0;\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n  "])), styles_1.rem(switchInput.width), styles_1.rem(switchInput.height), styles_1.rem(switchInput.height / 2));
}
...
function switchThumbStyles(props) {
    ...
    var switchInput = theme.sanity.input.switch;
    var trackWidth = switchInput.width;
    var trackHeight = switchInput.height;
    var trackPadding = switchInput.padding;
    var size = trackHeight - switchInput.padding * 2;
    ...
    return styled_components_1.css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    &&:not([hidden]) {\n      display: block;\n    }\n    position: absolute;\n    left: ", ";\n    top: ", ";\n    height: ", ";\n    width: ", ";\n    border-radius: ", ";\n    transition-property: transform;\n    transition-duration: ", "ms;\n    transition-timing-function: ", ";\n    background: var(--switch-fg-color);\n    transform: translate3d(0, 0, 0);\n\n    ", "\n\n    ", "\n  "], ["\n    &&:not([hidden]) {\n      display: block;\n    }\n    position: absolute;\n    left: ", ";\n    top: ", ";\n    height: ", ";\n    width: ", ";\n    border-radius: ", ";\n    transition-property: transform;\n    transition-duration: ", "ms;\n    transition-timing-function: ", ";\n    background: var(--switch-fg-color);\n    transform: translate3d(0, 0, 0);\n\n    ",
        "\n\n    ",
        "\n  "])), styles_1.rem(trackPadding), styles_1.rem(trackPadding), styles_1.rem(size), styles_1.rem(size), styles_1.rem(size / 2), switchInput.transitionDurationMs, switchInput.transitionTimingFunction, checked && styled_components_1.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      transform: translate3d(", "px, 0, 0);\n    "], ["\n      transform: translate3d(", "px, 0, 0);\n    "])), checkedOffset), indeterminate && styled_components_1.css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      transform: translate3d(", "px, 0, 0);\n    "], ["\n      transform: translate3d(", "px, 0, 0);\n    "])), indeterminateOffset));
}
