...
function MenuButton(_a) {
    var boundaryElement = _a.boundaryElement, buttonProp = _a.button, id = _a.id, menuProp = _a.menu, placement = _a.placement, popoverScheme = _a.popoverScheme, portal = _a.portal, radius = _a.radius;
    ...
    return (react_1.default.createElement(atoms_1.Popover, { boundaryElement: boundaryElement, content: menu, "data-ui": "MenuButton", open: open, placement: placement, portal: portal, radius: radius, scheme: popoverScheme }, button || react_1.default.createElement(react_1.default.Fragment, null)));
}
