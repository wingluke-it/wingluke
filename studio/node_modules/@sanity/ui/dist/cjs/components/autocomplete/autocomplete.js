...
var ClearButtonBox = styled_components_1.default(atoms_1.Box)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  z-index: 1;\n\n  & > button {\n    vertical-align: top;\n  }\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  z-index: 1;\n\n  & > button {\n    vertical-align: top;\n  }\n"])));
var defaultRenderOption = function (_a) {
    var value = _a.value;
    return (react_1.default.createElement(atoms_1.Card, { as: "button", padding: 3 },
        react_1.default.createElement(atoms_1.Text, null, value)));
};
...
var InnerAutocomplete = react_1.forwardRef(function (props, ref) {
    var _a = props.border, border = _a === void 0 ? true : _a, filterOptionProp = props.filterOption, icon = props.icon, id = props.id, loading = props.loading, onChange = props.onChange, onQueryChange = props.onQueryChange, onSelect = props.onSelect, _b = props.options, optionsProp = _b === void 0 ? [] : _b, _c = props.padding, paddingProp = _c === void 0 ? 3 : _c, _d = props.radius, radius = _d === void 0 ? 2 : _d, renderOptionProp = props.renderOption, _e = props.renderValue, renderValue = _e === void 0 ? defaultRenderValue : _e, _f = props.size, size = _f === void 0 ? 2 : _f, _g = props.value, valueProp = _g === void 0 ? '' : _g, restProps = __rest(props, ["border", "filterOption", "icon", "id", "loading", "onChange", "onQueryChange", "onSelect", "options", "padding", "radius", "renderOption", "renderValue", "size", "value"]);
    ...
    return (react_1.default.createElement(styles_2.Root, { "data-ui": "Autocomplete", onBlur: handleRootBlur, onKeyDown: handleRootKeyDown, ref: rootRef },
        react_1.default.createElement(atoms_1.TextInput, __assign({}, restProps, { "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listboxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border, icon: icon, id: id, inputMode: "search", onChange: handleInputChange, onFocus: handleInputFocus, padding: padding, radius: radius, ref: setRef, role: "combobox", size: size, spellCheck: false, value: query === null ? renderValue(value, currentOption) : query })),
        value.length > 0 && (react_1.default.createElement(ClearButtonBox, { margin: padding.map(function (v) { return v - 1; }), onFocus: handleClearButtonFocus },
            react_1.default.createElement(atoms_1.Button, { "aria-label": "Clear", "data-qa": "clear-button", icon: "close", mode: "bleed", onClick: handleClearButtonClick, padding: padding.map(function (v) { return v - 2; }), size: size }))),
        react_1.default.createElement(styles_2.ListBoxContainer, { hidden: !expanded },
            react_1.default.createElement(styles_2.ListBoxCard, { paddingY: 1, radius: 1, shadow: 2, tabIndex: -1 },
