...
function responsiveInputPaddingStyle(props) {
    ...
    var size = helpers_1.getResponsiveProp(props.uiSize, [0]);
    ...
    return helpers_1.responsive(theme.sanity.media, _padding.map(function (_, i) {
        var fontSize = theme.sanity.fonts.text.sizes[_size[i]] || theme.sanity.fonts.text.sizes[2];
        var emSize = fontSize.lineHeight - fontSize.ascenderHeight - fontSize.descenderHeight;
        var p = theme.sanity.space[_padding[i]];
        var s = theme.sanity.space[_space[i]];
        var styles = {
