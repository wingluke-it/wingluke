...
const InnerAutocomplete = forwardRef((props, ref) => {
    const { border = true, filterOption: filterOptionProp, icon, id, loading, onChange, onQueryChange, onSelect, options: optionsProp = [], padding: paddingProp = 3, radius = 2, renderOption: renderOptionProp, renderValue = defaultRenderValue, size = 2, value: valueProp = '' } = props, restProps = __rest(props, ["border", "filterOption", "icon", "id", "loading", "onChange", "onQueryChange", "onSelect", "options", "padding", "radius", "renderOption", "renderValue", "size", "value"]);
    ...
    return (React.createElement(Root, { "data-ui": "Autocomplete", onBlur: handleRootBlur, onKeyDown: handleRootKeyDown, ref: rootRef },
        React.createElement(TextInput, Object.assign({}, restProps, { "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listboxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border, icon: icon, id: id, inputMode: "search", onChange: handleInputChange, onFocus: handleInputFocus, padding: padding, radius: radius, ref: setRef, role: "combobox", size: size, spellCheck: false, value: query === null ? renderValue(value, currentOption) : query })),
        value.length > 0 && (React.createElement(ClearButtonBox, { margin: padding.map((v) => v - 1), onFocus: handleClearButtonFocus },
            React.createElement(Button, { "aria-label": "Clear", "data-qa": "clear-button", icon: "close", mode: "bleed", onClick: handleClearButtonClick, padding: padding.map((v) => v - 2), size: size }))),
