...
export function MenuButton({ boundaryElement, button: buttonProp, id, menu: menuProp, placement, popoverScheme, portal, radius, }) {
    ...
    return (React.createElement(Popover, { boundaryElement: boundaryElement, content: menu, "data-ui": "MenuButton", open: open, placement: placement, portal: portal, radius: radius, scheme: popoverScheme }, button || React.createElement(React.Fragment, null)));
}
