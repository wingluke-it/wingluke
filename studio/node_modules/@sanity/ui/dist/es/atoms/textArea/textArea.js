...
export const TextArea = forwardRef((props, forwardedRef) => {
    const { border = true, disabled = false, padding = [3], paddingX, customValidity, paddingY, paddingTop, paddingBottom, paddingLeft, paddingRight, radius = [1], size: sizeProp = [2] } = props, restProps = __rest(props, ["border", "disabled", "padding", "paddingX", "customValidity", "paddingY", "paddingTop", "paddingBottom", "paddingLeft", "paddingRight", "radius", "size"]);
    const paddingProps = {
        padding,
        paddingX,
        paddingY,
    ...
    return (React.createElement(Root, null,
        React.createElement(InputRoot, null,
            React.createElement(Input, Object.assign({}, restProps, paddingProps, { disabled: disabled, ref: ref, uiSize: uiSize })),
