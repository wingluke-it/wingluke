...
export const TextInput = forwardRef((props, forwardedRef) => {
    const { border = true, disabled = false, icon, iconRight, padding = 3, prefix, radius = 1, size = 2, space = 3, suffix, customValidity, type = 'text' } = props, restProps = __rest(props, ["border", "disabled", "icon", "iconRight", "padding", "prefix", "radius", "size", "space", "suffix", "customValidity", "type"]);
    ...
    return (React.createElement(Root, null,
        ...
        React.createElement(InputRoot, null,
            React.createElement(Input, Object.assign({}, restProps, { disabled: disabled, iconLeft: Boolean(icon), iconRight: Boolean(iconRight), padding: padding, ref: ref, space: space, type: type, uiSize: size })),
            React.createElement(Presentation, { border: border, hasPrefix: Boolean(prefix), hasSuffix: Boolean(suffix), radius: radius },
                icon && (React.createElement(IconLeftBox, { padding: padding },
                    React.createElement(Text, { size: size },
