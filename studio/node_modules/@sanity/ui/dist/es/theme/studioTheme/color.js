...
export const color = createColorTheme({
    ...
    button: ({ base, mode, muted, solid }) => {
        if (mode === 'bleed') {
            return {
                enabled: Object.assign(Object.assign({}, muted.enabled), { bg: 'transparent', border: 'transparent' }),
                hovered: Object.assign(Object.assign({}, muted.hovered), { bg: muted.enabled.bg, border: 'transparent' }),
                pressed: Object.assign(Object.assign({}, muted.pressed), { border: 'transparent' }),
                disabled: Object.assign(Object.assign({}, muted.disabled), { bg: 'transparent', border: 'transparent' }),
                selected: Object.assign(Object.assign({}, muted.selected), { border: 'transparent' }),
            };
        }
        return {
            enabled: mode === 'ghost'
                ? Object.assign(Object.assign({}, muted.enabled), { bg: 'transparent', border: base.border }) : Object.assign(Object.assign({}, solid.enabled), { border: 'transparent' }),
            hovered: Object.assign(Object.assign({}, solid.hovered), { border: 'transparent' }),
            pressed: Object.assign(Object.assign({}, solid.pressed), { border: 'transparent' }),
            selected: Object.assign(Object.assign({}, solid.selected), { border: 'transparent' }),
            disabled: mode === 'ghost'
                ? Object.assign(Object.assign({}, muted.disabled), { bg: 'transparent', border: muted.disabled.bg }) : Object.assign(Object.assign({}, solid.disabled), { border: 'transparent' }),
        };
    },
