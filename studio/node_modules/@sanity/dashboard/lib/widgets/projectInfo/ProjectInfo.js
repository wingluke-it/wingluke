...
class ProjectInfo extends _react.default.PureComponent {
  ...
  componentDidMount() {
    // fetch project data
    this.subscriptions = [];
    this.subscriptions.push(_client.default.observable.request({
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, this.props.__experimental_before && this.props.__experimental_before.map((widgetConfig, idx) => /*#__PURE__*/_react.default.createElement(_widgetContainer.default, {
      key: String(idx),
      config: widgetConfig
    ...
    }, "Project info")), /*#__PURE__*/_react.default.createElement("table", {
      ...
      return /*#__PURE__*/_react.default.createElement("tbody", {
        ...
        }, row.title), (0, _isPlainObject2.default)(row.value) && /*#__PURE__*/_react.default.createElement("td", {
          className: _ProjectInfo.default.apiError
        }, row.value.error), !(0, _isPlainObject2.default)(row.value) && /*#__PURE__*/_react.default.createElement("td", null, isUrl(row.value) ? /*#__PURE__*/_react.default.createElement("a", {
          href: row.value
        }, row.value) : row.value));
      }));
    })), /*#__PURE__*/_react.default.createElement("div", {
