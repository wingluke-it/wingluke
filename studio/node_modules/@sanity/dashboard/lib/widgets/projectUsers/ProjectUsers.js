...
class ProjectUsers extends _react.default.PureComponent {
  ...
  fetchData() {
    ...
    this.subscription = _client.default.observable.request({
      uri: "/projects/".concat(projectId)
    }).pipe((0, _operators.switchMap)(project => _client.default.observable.request({
