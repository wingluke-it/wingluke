...
class BlockEditor extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "scrollContainer", /*#__PURE__*/_react.default.createRef());

    _defineProperty(this, "editor", /*#__PURE__*/_react.default.createRef());

    _defineProperty(this, "editorWrapper", /*#__PURE__*/_react.default.createRef());
