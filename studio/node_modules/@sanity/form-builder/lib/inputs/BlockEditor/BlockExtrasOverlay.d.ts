...
import { BlockContentFeatures, Marker, FormBuilderValue, SlateEditor, SlateValue, SlateNode, RenderBlockActions, RenderCustomMarkers } from './typeDefs';
...
export default class BlockExtrasOverlay extends React.Component<Props, State> {
    ...
    renderBlockExtras: (node: SlateNode) => JSX.Element;
    render(): JSX.Element;
}
export {};
