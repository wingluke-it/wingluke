...
export default class Editor extends React.Component<Props, {}> {
    ...
    handlePaste: (event: React.SyntheticEvent, editor: any, next: () => void) => Promise<any> | void;
    handleCopy: (event: React.SyntheticEvent, editor: any, next: (arg0: void) => void) => any;
    handleDrag: (event: React.DragEvent, editor: any, next: (arg0: void) => void) => true | void;
    handleToggleFullscreen: (event: React.SyntheticEvent, editor: any, next: (arg0: void) => void) => true | void;
    handleCancelEvent: (event: React.SyntheticEvent) => void;
    refBlockDragMarker: (blockDragMarker: HTMLDivElement | null) => void;
